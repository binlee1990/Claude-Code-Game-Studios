...
> **Status**: Deferred (2D top-down fallback active for vertical slice)
> **Layer**: Presentation
> **Type**: Visual/Feel
...
**Status**: [ ] Deferred after readability feedback; formal slice currently uses 2D top-down fallback
