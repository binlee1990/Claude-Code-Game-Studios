...
- [x] GIVEN: `softcap(500, 100, 0.5)`，**WHEN** 求值，**THEN** 结果为 `120.0`
- [x] GIVEN: `softcap(50, 100, 0.5)`（value < threshold），**WHEN** 求值，**THEN** 结果为 `50.0`
- [x] GIVEN: `log_softcap(1000, 100)`，**WHEN** 求值，**THEN** 结果约为 `104.1`
...
- Sprint execution order: Sprint 3, story 20/20
