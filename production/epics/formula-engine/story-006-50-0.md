...
- [x] GIVEN: `log_softcap(50, 100)`（value < threshold），**WHEN** 求值，**THEN** 结果为 `50.0`
- [x] GIVEN: `clamp(15, 0, 10)`，**WHEN** 求值，**THEN** 结果为 `10.0`
- [x] GIVEN: `floor(3.7)`，**WHEN** 求值，**THEN** 结果为 `3.0`
...
- Sprint execution order: Sprint 4, story 1/20
