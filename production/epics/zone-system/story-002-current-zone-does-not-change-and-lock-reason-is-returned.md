...
- [x] GIVEN: player tries to select locked zone, **WHEN** selection is attempted, **THEN** current zone does not change and lock reason is returned.
- [x] GIVEN: active zone has enemy weights, **WHEN** SemiAutoCombat requests pool, **THEN** pool contains only valid enemy ids and weights.
...
- Sprint execution order: Sprint 9, story 9/20
