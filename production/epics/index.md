...
| equipment-system | Feature | 装备系统 | equipment-system.md | 12 stories | Complete |
...
| chapter-03 | Content | Ch.3 内容 | chapter-03.md | 4 stories (1 complete, 3 Backlog) | Sprint-007 Battle 1 Complete |
| localization | Foundation | 多语言管理 | localization-system.md | 3 stories (1 Integration, 1 UI, 1 Integration) | Complete |
| bond-system | Feature | 羁绊系统 MVP | bond-system.md | 4 stories | Sprint-007 Tavern MVP Complete |
| base-system | Feature | 基地系统 Phase 1 | base-system.md | 4 stories | Sprint-007 Phase 1 Complete |
...
- Fog-of-war remains readiness only for Sprint-006+ planning.
