...
Sprint-009 完成 Vertical Slice 层 4 系统（fog/bond-combo/difficulty/boss），1021/1021 PASS。
...
| MILESTONE-001 | Milestone review 更新（VS Complete, 19 epics, 1021 tests, Post-Sprint-009 state） | Review | RETRO-001 | `production/reviews/milestone-review-vs-complete-2026-05-17.md` 存在 |
...
| REGRESSION-001 | Regression suite 创建 + 全量回归跑（GDD critical path → test 映射，覆盖固定 bug 的回测） | QA | 1021 PASS baseline | `tests/regression-suite.md` 存在，全量 GUT 仍然 ≥1021 PASS |
